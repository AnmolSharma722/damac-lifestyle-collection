...
export default function QuickFacts() {
  return (
    <section className="bg-brand-dark">
      <div className="mx-auto flex max-w-content flex-col gap-6 px-5 py-6 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:px-8">
        <dl className="grid grid-cols-2 gap-x-6 gap-y-5 sm:flex sm:flex-1 sm:flex-wrap sm:items-center sm:gap-x-8 sm:gap-y-4">
          {FACTS.map((f, i) => (
            <div
              key={f.label}
        ...
        <a href="#contact" className="btn-gold w-full shrink-0 !px-6 !py-3 text-xs sm:w-auto sm:text-sm">
          <PhoneIcon />
